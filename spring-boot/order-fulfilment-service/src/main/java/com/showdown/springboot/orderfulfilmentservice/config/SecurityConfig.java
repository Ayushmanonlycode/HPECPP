package com.showdown.springboot.orderfulfilmentservice.config;
...
/**
 * Security configuration for the Order Fulfilment Service.
 *
 ...
 * All fulfilment operations require a valid Bearer token.
 */
@Configuration
@EnableWebSecurity
